var mainState = {
    ...
    create: function() { 
		...
		this.plant = game.add.sprite(650, 200, 'plant');
		...
		this.plant.scale.x = 1;
		this.plant.scale.y = 1;
		...
		//show controls
    	previewLabel = game.add.text(game.world.centerX+25, game.world.centerY-100, '『preview』', {font: '24px Roboto', fill: '#151515'});
